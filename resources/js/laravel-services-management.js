...
$(function () {
  ...
  var dt_servicios_table = $('.datatables-servicios'),
    offCanvasForm = $('#offcanvasAddServicio');
  ...
  // Users datatable
  if (dt_servicios_table) {
    var dt_servicios = dt_servicios_table.DataTable({
      processing: true,
      serverSide: true,
      ajax: {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return '<span class="user-emaidt_serviciosl">' + $descripcion + '</span>';
          }
        },
        {
          // Actions

    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 text-white">
        ...
        <ul class="list-unstyled">
          @php
$items = [
  ['title' => 'Retail & centros comerciales', 'desc' => 'Activaciones, campañas, aperturas que generan expectación y resultados.'],
  ['title' => 'Convenciones y eventos empresariales', 'desc' => 'Reuniones corporativas con un twist que las hace memorables.'],
  ['title' => 'Networking y team building', 'desc' => 'Fortalecemos equipos a través de experiencias compartidas únicas.'],
  ['title' => 'Eventos privados', 'desc' => 'Celebraciones con concepto donde cada detalle cuenta una historia.'],
  ['title' => 'Experiencias musicales y culturales', 'desc' => 'Espacios donde el arte y la música crean momentos inolvidables.']
];
      @endphp

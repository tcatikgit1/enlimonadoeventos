  ...
  [
    ...
    @endphp
      ...
      <div class="position-relative rounded-4 overflow-hidden shadow-sm equipo-card"
       style="background-image: url('{{ asset($persona['img']) }}'); background-size: cover; background-position: center; height: 450px;"
       data-overlay="{{ $persona['color'] }}">
    <div
      class="overlay position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center align-items-center text-center px-3 transition"

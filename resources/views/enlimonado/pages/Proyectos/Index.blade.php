    ...
    <div class="container">
      <div class="row justify-content-start" style="margin-top: 9%; margin-bottom: 9%;">
        <div class="col-xl-7 col-lg-8 col-md-10">
          <h2 class="fw-bold display-3 mb-4" style="color: #ffffff;">Proyectos <span class="lime-text">Enlimonados</span></h2>
          <p class="fs-4 text-white-50">Un recorrido visual por nuestras creaciones más ácidas y bizarras. Eventos únicos que han dejado huella.</p>
        </div>
      </div>
    </div>
  </section>

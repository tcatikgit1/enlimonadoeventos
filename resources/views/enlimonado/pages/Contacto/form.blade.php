        ...
        <form>
          ...
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <input type="text" name="name" class="form-control bg-dark text-white border-0" placeholder="Tu nombre"
                required>
            </div>
            <div class="col-md-6">
      ...
      <div class="col-lg-5 d-flex flex-column mt-5 mt-lg-0">
        ...
        <div class="d-flex align-items-start mb-8">
          ...
          <div>
            ...
            <small class="text-muted fst-italic">(Pero trabajamos donde haga falta, incluso en el desierto con generador
              portátil y DJ)</small>
          </div>
        </div>
        ...
        <div class="p-4 rounded mt-4" style="background-color: #1c1c1e;">
          ...
          <p class="text-white-50 mb-3">Programa una llamada con nuestro equipo para discutir tu proyecto en detalle.
          </p>
          <a href="tel:+34928123456" class="btn"
            style="background-color: #000000; color: #B9FF38; border: 1px solid #B9FF38;">
            Llamar ahora <i class="fas fa-arrow-right ms-1"></i>
          </a>
        </div>
      </div>
    </div>

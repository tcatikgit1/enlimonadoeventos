<section class="contact-section py-10" style="background: linear-gradient(to bottom, #000000 30%, #160b24 100%);">
    <div class="container">
                ...
                <div class="rounded p-4 mt-5" style="border: 1px solid rgba(66, 59, 59, 0.848); background: #110F15;">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="fs-5 mb-2" style="color: rgba(255, 255, 255, 0.8);"><i
                            ...
                            calificó el evento como 'excepcional'</li>
                        <li class="fs-5 mb-2" style="color: rgba(255, 255, 255, 0.8);"><i
                                class="ti ti-circle-check-filled fs-3" style="color: #B9FF38"></i> Aumento del 40% en la
                            participación post-evento</li>
                        <li class="fs-5 mb-2" style="color: rgba(255, 255, 255, 0.8);"><i
                                class="ti ti-circle-check-filled fs-3" style="color: #B9FF38"></i> Incremento del 25% en
                            la aplicación de conceptos clave</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="rounded p-4 mt-5" style="border: 1px solid rgba(66, 59, 59, 0.848); background: #110F15;">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="fs-5 mb-2" style="color: rgba(255, 255, 255, 0.8);"><i
                            ...
                            en tráfico peatonal</li>
                        <li class="fs-5 mb-2" style="color: rgba(255, 255, 255, 0.8);"><i
                                class="ti ti-circle-check-filled fs-3" style="color: #B9FF38"></i> 15,000+ interacciones
                            en redes sociales</li>
                        <li class="fs-5 mb-2" style="color: rgba(255, 255, 255, 0.8);"><i
                                class="ti ti-circle-check-filled fs-3" style="color: #B9FF38"></i> 45% de aumento en
                            ventas durante la campaña</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-start mb-5">
            <div class="col-12 col-lg-6 p-4">
                <img src="/assets/img/enlimonado/exitos/exitos3.webp" alt="Festival"
                    class="img-fluid rounded w-100 h-auto" style="max-height: 500px;">
            </div>
            <div class="col-12 col-lg-6 p-4 text-light">
                ...
                <div class="rounded p-4 mt-5" style="border: 1px solid rgba(66, 59, 59, 0.848); background: #110F15;">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="fs-5 mb-2" style="color: rgba(255, 255, 255, 0.8);"><i
                            ...
                            durante dos días</li>
                        <li class="fs-5 mb-2" style="color: rgba(255, 255, 255, 0.8);"><i
                                class="ti ti-circle-check-filled fs-3" style="color: #B9FF38"></i> Valoración media de
                            4.8/5 estrellas</li>
                        <li class="fs-5 mb-2" style="color: rgba(255, 255, 255, 0.8);"><i
                                class="ti ti-circle-check-filled fs-3" style="color: #B9FF38"></i> 90% de intención de
                            repetir asistencia</li>
                    </ul>
                </div>
            </div>
        </div>

...
// Ensure the NavbarFull controller exists in the specified namespace
...
Route::get('/laravel/services-management', [ServicesManagement::class, 'ServicesManagement'])->name('laravel-example-services-management');

Route::resource('/user-list', UserManagement::class);
Route::resource('/service-list', ServicesManagement::class);
